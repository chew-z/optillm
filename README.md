...
_Full benchmark results [below](#sota-results-on-benchmarks-with-optillm)_ ⬇️
...
2024-09-06 07:57:14,191 - INFO - Server configuration: {'approach': 'auto', 'mcts_simulations': 2, 'mcts_exploration': 0.2, 'mcts_depth': 1, 'best_of_n': 4, 'model': 'gpt-4o-mini', 'rstar_max_depth': 3, 'rstar_num_rollouts': 5, 'rstar_c': 1.4, 'base_url': ''}
...
| `--best-of-n`            | Number of samples for best_of_n approach                        | 4               |
