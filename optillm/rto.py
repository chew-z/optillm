...
def round_trip_optimization(
    ...
    if (
        ...
        response_dict = (
            response_c1.model_dump()
            if hasattr(response_c1, "model_dump")
            else response_c1
        )
    ...
    if (
        ...
        response_dict = (
            response_q2.model_dump()
            if hasattr(response_q2, "model_dump")
            else response_q2
        )
        optillm.conversation_logger.log_provider_call(
            request_id, provider_request, response_dict
    ...
    if (
        ...
        response_dict = (
            response_c2.model_dump()
            if hasattr(response_c2, "model_dump")
            else response_c2
        )
        optillm.conversation_logger.log_provider_call(
            request_id, provider_request, response_dict
    ...
    if (
        ...
        response_dict = (
            response_c3.model_dump()
            if hasattr(response_c3, "model_dump")
            else response_c3
        )
        optillm.conversation_logger.log_provider_call(
            request_id, provider_request, response_dict
