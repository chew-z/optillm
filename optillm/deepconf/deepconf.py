...
def deepconf_decode(
    ...
    # Log configuration
    logger.info(
        f"DeepConf configuration: variant={config['variant']}, "
    ...
    try:
        ...
        logger.info(
            f"DeepConf decoding completed successfully. "
...
def format_deepconf_response(
    answer: str, stats: Dict[str, Any], config: Dict[str, Any]
) -> str:
    """
