...
SOURCES = {
    ...
    "boolq": {
        ...
        "subset": None,
        "samples": 125,
        "field_map": {"question": "question", "passage": "passage", "answer": "answer"},
    },
    "mmlu_math": {
        "name": "cais/mmlu",
        "subset": "all",
    ...
    "aqua_rat": {
        ...
        "subset": None,
        "samples": 125,
        "field_map": {"question": "question", "answer": "correct"},
    },
}
        ...
        try:
            if category == "gsm8k":
                ...
                if 0 <= answer_index < len(choices):
                    ...
                    print(
                        f"Warning: Answer index '{answer_index}' is out of range for choices: {choices}"
                    )
    ...
    for category, config in tqdm(SOURCES.items(), desc="Processing datasets"):
        ...
        try:
            examples = select_challenging_examples(
                dataset, category, config["samples"], config["field_map"]
            )
